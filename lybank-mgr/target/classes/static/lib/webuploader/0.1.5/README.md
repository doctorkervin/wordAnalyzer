...
├
├── webuploader.flashonlypay.js          # 只有Flash实现的版本。
├── webuploader.flashonlypay.min.js      # min版本
├
├── webuploader.html5onlypay.js          # 只有Html5实现的版本。
├── webuploader.html5onlypay.min.js      # min版本
├
