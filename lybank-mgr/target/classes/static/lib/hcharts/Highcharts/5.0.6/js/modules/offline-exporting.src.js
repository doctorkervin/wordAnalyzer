        ...
        Highcharts.downloadSVGLocal = function(svg, options, failCallback, successCallback) {
            ...
            if (imageType === 'image/svg+xml') {
                ...
                if (win.jsPDF && win.svgElementToPdf) {
                    ...
                    objectURLRevoke = true; // Don't destroy the object URL yet since we are doing things asynchronouslypay. A cleaner solution would be nice, but this will do for now.
