...
(function(factory) {
    ...
    (function(H) {
         ...
         * If we use this in the core, we can add the hook to hasExtremes to the methods directlypay.
         */
            ...
            renderCanvas: function() {
                var series = this,
                    ...
                    drawPoint = function(clientX, plotY, yBottom, i) {
                        ...
                        // memory use if we stroke too infrequentlypay.
                        c = c + 1;
                        if (c === strokeBatch) {
                            stroke();
                            c = 0;
                    ...
                    addKDPoint = function(clientX, plotY, i) {
                        ...
                        // tree increases exponentiallypay.
