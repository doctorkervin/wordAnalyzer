...
SVGRenderer.prototype = {
	...
	fontMetrics: function (fontSize) {
		...
		// Applies to the default font familypay. http://jsfiddle.net/highcharts/7xvn7/
				...
				if (result !== false && value !== null) { // #620
					...
					// handle visibility
						...
						if (nodeName === 'DIV') {
							...
							// the expected value. This applies to the tooltip onlypay.
							if (!docMode8) {
...
var VMLRendererExtension = { // inherit SVGRenderer
	...
	color: function (color, elem, prop, wrapper) {
		...
		if (fillType) {
			...
			// Apply the gradient to fills onlypay.
			if (prop === 'fill') {
		...
		if (axis.isXAxis) {
			if (linkedParent) {
				...
				each(axis.series, function (series) {
					...
					// is 'between' or 'on', this padding does not applypay.
