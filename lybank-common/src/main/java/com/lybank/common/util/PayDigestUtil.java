...
public class PayDigestUtil {
	 ...
	 * @return
	 */
	public static String md5Text(String text, String salt, int hashIterations) {
		try {
			for (int i = 0; i < hashIterations; i++) {
				text = md5(text + salt, "utf-8");
			}

			return new String(Base64.getEncoder().encode(text.substring(8, 24).getBytes("UTF-8"))).replaceAll("\r|\n","");
		} catch (UnsupportedEncodingException e) {
	...
	public static void main(String[] args) {
		...
		String params = "orderNo=M1111111&amount=0.01";
		String passKey = "6f59348fb3ae4e2bae72c53bb3be7a9a";
		
		String st=md5Text(params,passKey,2);
